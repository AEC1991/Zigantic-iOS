...
extension MICountryPicker {
    ...
    override open func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        delegate?.countryPicker(self, didSelectCountryWithName: country.name, code: country.dialCode, flag: UIImage(named: bundle + country.code.lowercased() + ".png", in: Bundle(for: MICountryPicker.self), compatibleWith: nil)!)
